...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Sara Johnson — Creative Freelancer · UI/UX, Web & Brand Design" },
      { property: "og:description", content: "Sara Johnson is a creative freelancer in Karachi designing web, UI/UX, brand, and content experiences that connect, convert and inspire." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#0a0a0f" },
      { name: "twitter:title", content: "Sara Johnson — Creative Freelancer · UI/UX, Web & Brand Design" },
      { name: "twitter:description", content: "Sara Johnson is a creative freelancer in Karachi designing web, UI/UX, brand, and content experiences that connect, convert and inspire." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/e89f1864-0c02-4eb1-bc00-b11ea94c6a03/id-preview-be42aba7--699b1d58-fc13-42c5-9853-119b3834315a.lovable.app-1780956485869.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/e89f1864-0c02-4eb1-bc00-b11ea94c6a03/id-preview-be42aba7--699b1d58-fc13-42c5-9853-119b3834315a.lovable.app-1780956485869.png" },
    ],
    links: [
